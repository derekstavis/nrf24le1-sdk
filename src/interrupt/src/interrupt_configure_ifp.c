...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
// void interrupt_configure_ifp(interrupt_ifp_input_t interrupt_ifp_input, unsigned char ifp_int_config_options);
//
// Description:
...
//   According to Table 47 on p. 100 of v. 3 of the datasheet, only one GPINT pin may be enabled at a time, and this function attempts
//   to heed that warning.
//
// Parameters:
//	interrupt_ifp_input_t interrupt_ifp_input - the GPINT to configure
//  unsigned int ifp_int_config_options - IFP configuration options
//
// Return value:
//  False if the user is trying to enable more than one input at a time, true otherwise
//
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
bool interrupt_configure_ifp(interrupt_ifp_input_t interrupt_ifp_input, unsigned char ifp_int_config_options)
{
	//Try to enable/disable the pin interrupt
	if(interrupt_ifp_input & INTERRUPT_IFP_CONFIG_OPTION_ENABLE)
	{
