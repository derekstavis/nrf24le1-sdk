...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
// unsigned int uart_calc_th1_value(unsigned long desired_baud_rate, bool smod_bit_value)
//
// Description:
//  Calculates a value for TH1 from the passed in values for baud rate and SMOD
//
// Parameters:
//  unsigned long desired_baud_rate - baud rate use in the calculation
...
unsigned char uart_calc_th1_value(unsigned long desired_baud_rate, bool smod_bit_value)
{
	...
	return (unsigned char)(256 - (((((unsigned long)(2 * ((smod_bit_value != 0) ? 2 : 1) * pwr_clk_mgmt_get_cclk_freq_in_hz())) / ((unsigned long)(384 * desired_baud_rate))) + 1) / 2));
}
